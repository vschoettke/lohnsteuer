...
module.exports = function Lohnsteuer2014Big(args) {
    ...
    function UPEVP() {
        if (KRV > 1) {
            ...
            //  Neuer Wert 2014
            VSP1 = (ZRE4VP.multiply(new BigDecimal("0.56"))).setScale(2, BigDecimal.ROUND_DOWN);
            ...
            if (ZZX.compareTo(new BigDecimal("9763")) === 1)             //  Neuer Wert 2014
{
                ...
                //  Neuer Wert 2014
                UP5_6();
                HOCH = (ST.add((ZZX.subtract(new BigDecimal("9763"))).multiply(new BigDecimal("0.42")))).setScale(0, BigDecimal.ROUND_DOWN);
                //  Neuer Wert 2014
